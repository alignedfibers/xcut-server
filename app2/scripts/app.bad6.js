...
function setBodyHeight(){
  ...
  ContentHeight = ContentRect.bottom - ContentRect.top;
  console.log("veiwport.height: "+ViewPort.height);
  console.log("BodyRect.height: "+ContentHeight);
  if(ContentHeight >= (ViewPort.height-10)){
  adjustedHeight = (ContentHeight)+(ViewPort.height)-(ContentHeight)+(ContentHeight*.5);
console.log("adjustedHeight: "+adjustedHeight);
  }else{
  adjustedHeight = ViewPort.height+(ViewPort.height*.6);
  }
console.log("adjustedHeight: "+adjustedHeight);
...
function dealWithCSSQuirks(){
  ...
  ThankYouHeight = ThankYouRect.bottom - ThankYouRect.top;
